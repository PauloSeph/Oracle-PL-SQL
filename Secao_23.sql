...
--Testes
ALTER TRIGGER valida_horario_curso DISABLE; -- para hablitar é so por enable
...
UPDATE TALUNO SET SALARIO = 3000; -- vai alterar todos registros da tabela Taluno.
